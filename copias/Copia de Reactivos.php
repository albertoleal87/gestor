...
Numero de Reactivos:<input type="text" name="reactivos" />
...
<input type="submit" name="creaseccion" value="Agrega seccion" />
<br>
<font color='#FF0000'>Esta seccion solo acepta maximo 100 reactivos, favor de ingresar un numero igual o menor a 100</font>
FORMULARIO;
}
...
<form action="$_SERVER[PHP_SELF]" method="post">
<font color='#FF0000'>
Ingrese un nombre de Tema con el cual se relacionan los reactivos:
<BR>
</font>
<div id="relacionar">
<br>
...
<br>
Ingrese un nombre de Materia con el cual se relacionan los reactivos:
